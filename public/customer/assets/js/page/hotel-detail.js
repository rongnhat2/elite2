                ...
                $('.hotel-room-list')
                    .append(`<div class="room-block">
                                ...
                                <div class="room-content">
                                    ...
                                    <a href="#room-list" class="room-order" data-id="${v.id}" data-name="${v.name}" data-prices="${prices}">Chọn phòng</a>
                                </div>
                            </div>`)
            })
        },
...
(() => { 
    ...
    function getData(){
        ...
        Api.Hotel.GetOne(tour_id)
            .done(res => {
                View.Hotel.render(res.data.hotel) 
                View.Room.render(res.data.room)
                localStorage.setItem("hotel-data", `{"id": "${res.data.hotel.id}", "name": "${res.data.hotel.name}", "location_name": "${res.data.hotel.location_name}"}`)
            })
