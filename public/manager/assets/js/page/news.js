    ...
    table: {
        ...
        init(){
            var row_table = [
                    ...
                    { title: 'Tiêu đề', name: 'name', orderable: true, width: '20%', },
                    { title: 'Hình ảnh', name: 'name', orderable: true, width: '20%', },
                    { title: 'Mô tả', name: 'image', orderable: true,  }, 
    ...
    FullTab: {  
        Create: { 
            ...
            getVal(resource){ 
                ...
                if (data_category == null) { required_data.push('Chọn danh mục.'); onPushData = false } 
