		...
		<div class="wrapper">
			...
			<div class="tour-page-main">
				...
				<div class="main-group">
					...
					<div class="group-detail">
						<a href="/category?tab=tour&location_type=1" class="detail-button">Xem thêm</a>
					</div>
				</div>
			</div>		
			...
			<div class="tour-page-main">
				...
				<div class="main-group">
					...
					<div class="group-detail">
						<a href="/category?tab=tour&location_type=2" class="detail-button">Xem thêm</a>
					</div>
				</div>
			</div>		
		</div>
...
@section('js') 
<script type="text/javascript" src="{{ asset("customer/assets/js/page/tour.js") }}"></script> 
@endsection()