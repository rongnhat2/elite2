                                    ...
                                    <div class="col-md-12"> 
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label control-label">Trạng thái</label> 
                                             <div class="col-md-8">
                                                <div class="radio">
                                                    <input id="radio1" name="booking" value="0" type="radio" checked="">
                                                    <label for="radio1">Đang chờ</label>
                                                </div>
                                                <div class="radio">
                                                    <input id="radio2" name="booking" value="1" type="radio">
                                                    <label for="radio2">Thanh toán thành công</label>
                                                </div>
                                                <div class="radio">
                                                    <input id="radio3" name="booking" value="2" type="radio">
                                                    <label for="radio3">Hủy phòng</label>
                                                </div>
                                                <div class="radio">
                                                    <input id="radio4" name="booking" value="3" type="radio">
                                                    <label for="radio4">Kết thúc</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/booking.js') }}"></script>
