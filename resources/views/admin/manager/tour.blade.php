...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="tour-group | tour">
@endsection()
...
<div class="page-header no-gutters has-tab">
    <div class="d-md-flex m-b-15 align-items-center justify-content-between notification relative" id="notification">
        <div class="media align-center justify-content-between m-b-15 w-100">
            <div class="m-l-15">
                <h4 class="m-b-0">Tour du lịch</h4>
            </div>
            @include('admin.alert')
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body"> 
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Lịch trình</a>
                        </li> 
                    </ul>
                    <div class="tab-content m-t-15" id="myTabContent">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label control-label">Tên tour*</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label control-label">Giá tour*</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control data-discount type-number" placeholder="%">
                                                            </div>
                                                        </div>
                                                    </div> 
                                                </div>
                        ...
                        <div class="tab-pane fade" id="policy" role="tabpanel" aria-labelledby="policy-tab">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-form-label control-label m-b-10">Bữa ăn * ( <p style="display: inline;">Xuống dòng để tách các chính sách</p> )</label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-form-label control-label m-b-10">Chỗ ở * ( <p style="display: inline;">Xuống dòng để tách các chính sách</p> )</label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-form-label control-label m-b-10">Chính sách không bao gồm * ( <p style="display: inline;">Xuống dòng để tách các chính sách</p> )</label>
                                        <div class="col-md-12">
                                            <textarea type="text" class="form-control data-policy-04" placeholder="" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-form-label control-label m-b-10">Chính Sách Hủy Bởi Khách Hàng * ( <p style="display: inline;">Xuống dòng để tách các chính sách</p> )</label>
                                        <div class="col-md-12">
                                            <textarea type="text" class="form-control data-policy-05" placeholder="" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-form-label control-label m-b-10">Chính Sách Trẻ Em * ( <p style="display: inline;">Xuống dòng để tách các chính sách</p> )</label>
                                        <div class="col-md-12">
                                            <textarea type="text" class="form-control data-policy-06" placeholder="" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="timeline-create col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                                <button class="btn btn-primary timeline-action" atr="Create TimeLine">Thêm lịch trình</button>
                            </div>
                        </div> 
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/tour.js') }}"></script>
