...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="yacht-group | yacht">
@endsection()
            ...
            <div class="card">
                <div class="card-body"> 
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="service-tab" data-toggle="tab" href="#service" role="tab" aria-controls="service" aria-selected="false">Lưu ý và quy định</a>
                        </li> 
                        <li class="nav-item">
                    ...
                    <div class="tab-content m-t-15" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="service" role="tabpanel" aria-labelledby="service-tab">
                            ...
                            <div class="services-create col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                                <button class="btn btn-primary services-action" atr="Create TimeLine">Thêm quy định</button>
                            </div>
                        </div> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label control-label">Tên phòng*</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control data-name" placeholder="">
                                                    </div>
                                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <label class="col-sm-12 col-form-label control-label m-b-10">Mô tả loại phòng*</label>
                                                <div class="col-md-12">
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/yacht.js') }}"></script>
